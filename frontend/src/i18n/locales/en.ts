...
export const en: Messages = {
  ...
  'board.viewTitle': 'Layout',
  'board.viewList': 'List',
  'board.viewCard': 'Cards',
  'board.colSymbol': 'Symbol',
  'board.colPrice': 'Last',
  'board.colChange': 'Chg',
  'board.colChangePct': 'Chg %',
  'board.colVolume': 'Volume',
  'board.colSignal': 'Signal',
  'board.sortBy': 'Sort by {column}',
  'board.expand': 'Show details',
  'board.collapse': 'Hide details',
  'board.popOut': 'Pop out',
  'board.popOutTitle': 'Put the watchlist in a floating window that stays on top of other apps',
  'board.popOutActive': 'The watchlist is showing in the floating window',
  'board.popIn': 'Bring back',
  'board.miniOpen': 'Mini window',
  'board.miniTitle': 'Open a chrome-free window sized to sit in a corner of the screen',
  'board.backToFull': 'Full view',
  'board.groupAll': 'All',
  'board.groupUngrouped': 'Ungrouped',
  'board.groupAdd': '+ Group',
  'board.groupAddTitle': 'Create a watchlist group',
  'board.groupNamePlaceholder': 'Group name',
  'board.groupRename': 'Rename',
  'board.groupDelete': 'Delete group',
  'board.groupDeleteConfirm':
    'Delete “{name}”? Stocks stay on the watchlist; they just become ungrouped.',
  'board.groupAssign': 'Group',
  'board.groupNone': 'Ungrouped',
  'board.groupFull': 'At most {max} groups',
  'board.groupDragHint': 'Hold and drag onto a group to file it',
  'board.groupEmptyDrop': 'Drop a stock here',
  'board.groupBarLabel': 'Watchlist groups',
  'board.groupNoneYet': 'No groups yet',
  'board.groupDroppable': 'Drop here',
  'board.groupDropHere': 'Release to file',
  'board.groupHere': 'Already here',
  'board.groupAllNotTarget': '“All” is a view, not a group — nothing can be filed into it',
  ...
  'realtime.emptyGroup': 'This group is empty. Add a stock above, or pick another group.',
  'realtime.emptyUngrouped': 'Every watchlist stock is already in a group.',
  ...
  // ---------- AI position call ----------
  'ai.title': 'AI position call',
  'ai.run': 'Ask AI',
  'ai.running': 'Thinking…',
  'ai.rerun': 'Ask again',
  'ai.callEnterLarge': 'Enter — large',
  'ai.callEnterMedium': 'Enter — medium',
  'ai.callEnterSmall': 'Enter — small',
  'ai.callExitLarge': 'Exit — large',
  'ai.callExitMedium': 'Exit — medium',
  'ai.callExitSmall': 'Exit — small',
  'ai.callHold': 'Hold',
  'ai.confidence': 'Confidence',
  'ai.confidenceHigh': 'high',
  'ai.confidenceMedium': 'medium',
  'ai.confidenceLow': 'low',
  'ai.reasons': 'Reasoning',
  'ai.risks': 'Risks',
  'ai.agreesWithRule': 'Agrees with the rule engine ({label})',
  'ai.differsFromRule': 'The rule engine says {label}; the AI disagrees',
  'ai.asOf': 'Based on the {date} close',
  'ai.generatedAt': 'Generated {time}',
  'ai.cached': 'Reusing an existing verdict',
  'ai.modelNote': '{model} · prompt {version}',
  'ai.quotaLeft': '{left} generations left today',
  'ai.quotaSpent': "Today's allowance is spent; it resets at {time}",
  'ai.empty': 'Ask the AI for an entry or exit call, and how much of a position it applies to.',
  'ai.unavailable': 'AI analysis is not configured on this server (no GEMINI_API_KEY).',
  'ai.insufficient': 'Not enough price history to judge.',
  'ai.failed': 'AI analysis failed: {message}',
  'ai.signIn': 'Sign in to use AI analysis.',
  'ai.runDeep': 'Deep analysis',
  'ai.runningDeep': 'Running deep analysis…',
  'ai.rerunDeep': 'Re-run deep',
  'ai.depthQuick': 'Price & volume',
  'ai.depthDeep': 'Deep',
  'ai.depthSelect': 'Which assessment to show',
  'ai.emptyDeep':
    'Ask the AI for an entry or exit call that also reads institutional flow and annual fundamentals.',
  'ai.deepIncluded':
    'Additionally drew on {days} sessions of institutional flow, margin balances and annual fundamentals.',
  'ai.deepLead':
    'A deep call also reads institutional flow and annual fundamentals. It counts against the same daily allowance.',
  'ai.gaps': 'Could not be included',
  'ai.disclaimerDeep':
    'Generated by an AI model from price and volume history, institutional flow and annual fundamentals — no news, no filings, no statement detail. For research only; not investment advice.',
  'ai.disclaimer':
    'Generated by an AI model from price and volume history alone — no fundamentals, institutional flow or news. For research only; not investment advice.',

  // ---------- hold analysis (Chen checklist) ----------
  'hold.title': 'Hold checklist',
  'hold.score': 'Hold score',
  'hold.scoreOf': '{score} / 100',
  'hold.unscored': 'Not enough data to score',
  'hold.judgedOn': 'Judged on {known} of {total} weight',
  'hold.suitStrong': 'Worth accumulating',
  'hold.suitOk': 'Reasonable',
  'hold.suitWeak': 'Weak case',
  'hold.suitAvoid': 'Not for holding',
  'hold.dimEarn': 'Earns every year',
  'hold.dimEfficient': 'Capital efficiency',
  'hold.dimCheap': 'Bought cheaply',
  'hold.dimCollect': 'Pays reliably',
  'hold.dimLiquid': 'Can be accumulated',
  'hold.statusPass': 'Pass',
  'hold.statusFail': 'Fail',
  'hold.statusUnknown': 'No data',
  'hold.evidenceEarn': 'Positive EPS in {positive} of the last {years} years',
  'hold.evidenceEarnUnknown': 'Only {years} year(s) of annual EPS stored',
  'hold.evidenceEfficient': 'ROE averaged {avg}% over {years} years',
  'hold.evidenceEfficientUnknown': 'Only {years} year(s) of annual ROE stored',
  'hold.evidenceCheap': 'PE {pe} against a sector ceiling of {ceiling}',
  'hold.evidenceCheapCape': '; cyclically adjusted {cape} against {ceiling}',
  'hold.evidenceCheapUnknown': 'No annual EPS, so PE cannot be computed',
  'hold.evidenceCollect': 'Paid {streak} years running; {years} paying years out of {window}',
  'hold.evidenceCollectYield': '; yield {yield}%',
  'hold.evidenceCollectUnknown': 'Payout record too short to judge',
  'hold.evidenceLiquid': '{lots} lots traded per day',
  'hold.evidenceLiquidUnknown': 'No daily bars stored',
  'hold.gaps': 'Not checked',
  'gap.noFundamentals':
    'Annual EPS and ROE are not wired up yet, so “earns every year”, “capital efficiency” and “bought cheaply” cannot be scored.',
  'gap.shortEps': 'Too few years of annual EPS to judge whether it earns consistently.',
  'gap.shortRoe': 'Too few years of annual ROE to judge capital efficiency.',
  'gap.noPe': 'No usable annual EPS, so there is no PE to compare.',
  'gap.tpexRecent':
    'TPEx publishes only a recent dividend window, so a payout streak cannot be established.',
  'gap.archiveNotWarmed':
    'Only the last few years of the dividend archive have been pulled. It paid in every one of them, but that is too few years to call it a streak — run the dividend warmup job to fill the rest.',
  'gap.noDividends': 'No dividend record for this stock in the window queried.',
  'gap.noBars': 'No daily bars loaded, so volume cannot be judged.',
  'gap.noChipData': 'No institutional daily report loaded, so flow could not be read.',
  'gap.partialChipCoverage':
    'The institutional report covers only a few sessions, so the five-day net is not representative.',
  'gap.noMarginData':
    'The margin and short report has not been published or loaded, so leverage could not be read.',
  'gap.noValuationHistory':
    'No daily PE or yield history stored yet, so there is no band to judge today against.',
  'gap.shortValuationHistory':
    'Less than a quarter of PE and yield history is stored, so the percentiles describe recent trading rather than a range.',
  'hold.dividendBlock': 'Dividends',
  'hold.valuationBlock': 'Valuation',
  'hold.streak': 'Paid running',
  'hold.streakYears': '{years} yr',
  'hold.yield': 'Cash yield',
  'hold.avgYield': 'Average yield',
  'hold.pe': 'PE',
  'hold.roe': 'ROE',
  'hold.avgVolume': 'Volume/day',
  'hold.lots': '{lots} lots',
  'hold.position': 'Two-year range position',
  'hold.stockDividend':
    'Paid a stock dividend in {years} of the last {window} years; the cash yield does not show that dilution.',
  'hold.disclaimer':
    'A published holding method encoded as a computable checklist — not the author’s opinion, and not investment advice. Judgements about moats and management are outside it.',

  // ---------- hold AI ----------
  'holdAi.title': 'AI hold assessment',
  'holdAi.run': 'Ask AI',
  'holdAi.running': 'Thinking…',
  'holdAi.rerun': 'Ask again',
  'holdAi.runDeep': 'Deep assessment',
  'holdAi.runningDeep': 'Running deep assessment…',
  'holdAi.rerunDeep': 'Re-run deep',
  'holdAi.depthQuick': 'Checklist',
  'holdAi.empty':
    'Ask the AI whether this company suits long-term dividend accumulation, from its payout record, fundamentals and price.',
  'holdAi.emptyDeep':
    'Ask the AI the same question with the year-by-year earnings and payout record, the valuation band and institutional flow on the table.',
  'holdAi.deepLead':
    'A deep assessment also reads the year-by-year payout and EPS record, where the PE and yield sit in this stock’s own range, and institutional flow. It counts against the same daily allowance.',
  'holdAi.deepIncluded':
    'Additionally drew on {years} years of payouts and earnings, and {days} sessions of institutional flow.',
  'holdAi.deepPayout': 'payouts ran at about {pct}% of the prior year’s EPS',
  'holdAi.deepBand': 'PE sits at the {pct}th percentile of its own last {days} sessions',
  'holdAi.signIn': 'Sign in to use the AI hold assessment.',
  'holdAi.agreesWithRules': 'Agrees with the checklist ({label})',
  'holdAi.differsFromRules': 'The checklist says {label}; the AI disagrees',
  'holdAi.noRuleVerdict': 'The checklist could not score this, so there is nothing to compare',
  'holdAi.insufficient': 'No daily bars loaded yet, so there is nothing to assess.',
  'holdAi.disclaimer':
    'Generated by an AI model from the payout record and whatever annual financials are stored — no industry outlook, no judgement of management. For research only; not investment advice.',
  'holdAi.disclaimerDeep':
    'Generated by an AI model from the year-by-year payout and earnings record, this stock’s own valuation range and institutional flow — no news, no statement detail, no judgement of management. For research only; not investment advice.',

  // ---------- hold backtest (the long gradesheet) ----------
  'hbt.title': 'Hold backtest',
  'hbt.window': 'Last {years} yr',
  'hbt.headline': 'Total return with dividends {total}',
  'hbt.headlineDetail': 'Price contributed {price}, the payouts {dividend} (reinvested).',
  'hbt.totalReturn': 'Total return',
  'hbt.priceReturn': 'Price only',
  'hbt.annualised': 'Annualised',
  'hbt.yieldOnCost': 'Yield on cost',
  'hbt.cashCollected': 'Cash per share',
  'hbt.maxDrawdown': 'Max drawdown',
  'hbt.beatIndex': 'The market returned {index} over the same sessions; this stock beat it by {excess} on price.',
  'hbt.trailIndex': 'The market returned {index} over the same sessions; this stock trailed it by {excess} on price.',
  'hbt.indexCaveat': 'Compared on price only — 加權指數 excludes dividends, so the total return above is not comparable to it.',
  'hbt.legendTotal': 'Dividends reinvested',
  'hbt.legendPrice': 'Price only',
  'hbt.fillTitle': 'Filling the ex-dividend gap',
  'hbt.fillSummary':
    'Filled {filled} of {events} ex-dividend gaps ({rate}%), median {days} days to recover.',
  'hbt.fillPending': '{pending} more are still inside their window and are not counted.',
  'hbt.fillPendingOnly':
    'All {pending} ex-dividend dates are still inside their window, so there is no fill rate yet.',
  'hbt.fillNone': 'No cash dividend was paid in this window.',
  'hbt.coverage':
    'Replayed {start} to {end} — {years} years, {bars} sessions. The window is however much daily history is loaded.',
  'hbt.stockDividendNote':
    'A stock dividend was paid in {years} of these years and is counted as extra shares — that part of the return is share count, not cash.',
  'hbt.coverageRecent':
    'TPEx publishes only a recent dividend window, so the payout record is incomplete and this return is understated.',
  'hbt.disclaimer':
    'Assumes one share bought at the start and every dividend reinvested at the ex-date close. No tax, no health levy, no brokerage, and no monthly-accumulation simulation. A real result would be somewhat worse.',
  'hbt.notEnoughBars': 'Not enough daily history yet (two years minimum). Widen the range above to load more.',
  'hbt.failed': 'Hold backtest failed to load: {message}',
