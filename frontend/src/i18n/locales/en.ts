...
export const en: Messages = {
  ...
  'hold.gapNoFundamentals':
    'Annual EPS and ROE are not wired up yet, so “earns every year”, “capital efficiency” and “bought cheaply” cannot be scored.',
  'hold.gapShortEps': 'Too few years of annual EPS to judge whether it earns consistently.',
  'hold.gapShortRoe': 'Too few years of annual ROE to judge capital efficiency.',
  'hold.gapNoPe': 'No usable annual EPS, so there is no PE to compare.',
  'hold.gapTpexRecent':
    'TPEx publishes only a recent dividend window, so a payout streak cannot be established.',
  'hold.gapArchiveNotWarmed':
  ...
  'hold.gapNoDividends': 'No dividend record for this stock in the window queried.',
  'hold.gapNoBars': 'No daily bars loaded, so volume cannot be judged.',
